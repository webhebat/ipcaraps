...
class Rekammedik_model extends CI_Model
{
    ...
    public function get_rekammedik($offset, $limit, $search, $warning, $jenis, $area, $tgl1, $tgl2, $validate, $subgrupid, $unit)
    {
        ...
        WHERE RM.deleted ='n' $whereadm1 $where  ORDER BY RM.registrasiid DESC";
    ...
    {
        $sql = "SELECT keluhan_penyerta FROM registrasi_spesifik_penyerta where registrasi_spesifikid = $id ";
