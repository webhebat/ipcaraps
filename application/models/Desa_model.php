...
class Desa_model extends CI_Model {
    ...
    {
        $sql="SELECT D.*,K.nama as kecamatan,J.nama as jenis FROM kelurahan D
        LEFT JOIN kecamatan K on D.id_kec = K.id_kec
        LEFT JOIN jenis J on D.id_jenis = J.id_jenis 
        WHERE 1 ";

        if ($q!=''){
        	$sql .=" AND D.nama like '%$q%' or K.nama like '%$q%' or J.nama like '%$q%' ";	
	    }
