...
class Tumortestis extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('tumortestis_model');
    }

    public function index()
    {
        cek_session_admin();
        $this->load->view('tumortestis_view');
    }
    ...
    function read()
    {
        ...
        $data   = $this->tumortestis_model->get_data($offset, $limit, $search, $warning, $jenis, $area, $tgl, $tgl2, $validate);
        $i  = 0;
        $rows   = array();
    ...
    {
        $data = $this->tumortestis_model->getdataoptions($id);
        $i = 0;
        $rows   = array();
        foreach ($data  as $r) {
    ...
    function getdatapenyerta()
    {
        ...
        $data = $this->tumortestis_model->getdatapenyerta($spesifikid);
        $i = 0;
    ...
    {
        $data = $this->tumortestis_model->getdatapenyerta2($id);
        $i = 0;
        $rows   = array();
        foreach ($data  as $r) {
    ...
    function getdarah()
    {
        ...
        $data = $this->tumortestis_model->getdarah($table, $tableid, $id);
        $i = 0;
    ...
    function getjenis()
    {
        ...
        $table = isset($_GET['table']) ? $_GET['table'] : '';
        $tableid = isset($_GET['tableid']) ? $_GET['tableid'] : '';
        $data = $this->tumortestis_model->getjenis($table, $tableid, $id);
        $i = 0;
    ...
    public function selectspesifik()
    {
        ...
        $data = $this->tumortestis_model->selectspesifik($offset, $limit, $search);
    ...
    function dataoptions()
    {
        ...
        $data = $this->tumortestis_model->options($type, $q);
        $i = 0;
    ...
    function save()
    {
        ...
        if ($this->tumortestis_model->simpan($data1, $data2))
            echo json_encode(array('success' => true));
        else
            echo json_encode(array('msg' => 'Gagal input data'));
    }
    ...
    function update($id = null)
    {
        ...
        $data1 = json_decode($this->input->get('datajson1'), true);
        $data2 = json_decode($this->input->get('datajson2'), true);
        if ($this->tumortestis_model->update($id, $data1, $data2))
            echo json_encode(array('success' => true));
        else
    ...
    function savefollowup()
    {
        ...
        if ($this->tumortestis_model->simpanfollowup())
            echo json_encode(array('success' => true));
        else
            echo json_encode(array('msg' => 'Gagal input data'));
    }
    ...
    function updatefollowup($id = null)
    {
        ...
        if ($this->tumortestis_model->updatefollowup($id))
            echo json_encode(array('success' => true));
        else
            echo json_encode(array('msg' => 'Gagal mengubah data'));
    }
    ...
    function deletefollowup()
    {
        ...
        if ($this->tumortestis_model->deletefollowup($id))
            echo json_encode(array('success' => true));
        else
            echo json_encode(array('msg' => 'Gagal mengubah data'));
    }
    ...
    function readfollowup()
    {
        ...
        $id = isset($_GET['id']) ? $_GET['id'] : '';
        $offset = ($offset - 1) * $limit;
        $data   = $this->tumortestis_model->get_followup($offset, $limit, $id);
        $i  = 0;
        $rows   = array();
        foreach ($data['data'] as $r) {
            //array keys ini = attribute 'field' di view nya
            $rows[$i] = $r;
            if ($r->penanda_tumor != '') {
                $rows[$i]->datapenanda = $this->getdataoptions($r->penanda_tumor);
            }
    ...
    function readkuratif()
    {
        ...
        //$id = $this->uri->segment(3);
        //$search2 = $this->uri->segment(4);
        $data   = $this->tumortestis_model->get_kuratif($offset, $limit, $id);
        $i  = 0;
        $rows   = array();
        foreach ($data['data'] as $r) {
            //array keys ini = attribute 'field' di view nya
    ...
    function savekuratif()
    {
        ...
        if ($this->tumortestis_model->simpankuratif())
            echo json_encode(array('success' => true));
        else
    ...
    function updatekuratif($id = NULL)
    {
        if (!isset($_POST))
            show_404();
        if ($this->tumortestis_model->updatekuratif($id))
            echo json_encode(array('success' => true));
        else
            echo json_encode(array('msg' => 'Gagal mengubah data'));
    }
    ...
    function deletekuratif()
    {
        if (!isset($_POST))
            show_404();
        $id = intval(addslashes($_POST['id']));
        if ($this->tumortestis_model->deletekuratif($id))
            echo json_encode(array('success' => true));
        else
            echo json_encode(array('msg' => 'Gagal mengubah data'));
    }
    ...
    function readluaran()
    {
        ...
        $data   = $this->tumortestis_model->get_luaran($id);
        $i  = 0;
        $rows   = array();
        foreach ($data['data'] as $r) {
            //array keys ini = attribute 'field' di view nya
    ...
    function saveluaran()
    {
        if (!isset($_POST))
            show_404();
        if ($this->tumortestis_model->createluaran())
            echo json_encode(array('success' => true));
        else
    ...
    function updateluaran($id = null)
    {
        ...
        if ($this->tumortestis_model->updateluaran($id))
            echo json_encode(array('success' => true));
        else
            echo json_encode(array('msg' => 'Gagal mengubah data'));
    }
    ...
    public function deleteluaran()
    {
        ...
        $id = intval(addslashes($_POST['id']));
        if ($this->tumortestis_model->deleteluaran($id))
            echo json_encode(array('success' => true));
        else
