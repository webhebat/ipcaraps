                            ...
                            <tr>
                                <td valign="top" style="padding-right: 30px">
                                    <table>
                                        ...
                                        <tr>
                                            <td>Propinsi</td><td>:</td><td><input name="propid" id="propid" class="easyui-textbox" style="width:200px"></td>
                                        </tr>
                                        <tr>
                                            <td>Kota/Kabupaten</td><td>:</td><td><input name="kabid" id="kabid" class="easyui-textbox" style="width:200px"></td>
                                        </tr>
                                        <tr>
                                            <td>Kecamatan</td><td>:</td><td><input name="camatid" id="camatid" class="easyui-textbox" style="width:200px"></td>
                                        </tr>
                                        <tr>
                                            <td>Kelurahan/Desa</td><td>:</td><td><input name="desaid" id="desaid" class="easyui-textbox" style="width:200px"></td>
                                        </tr>
                                    </table>
                                </td>
                                <td valign="top">
                                    <table>
                                        ...
                                        <tr>
                                            <td>Propinsi</td><td>:</td><td><input name="propid_2" id="propid_2" class="easyui-textbox" style="width:200px"></td>
                                        </tr>
                                        <tr>
                                            <td>Kota/Kabupaten</td><td>:</td><td><input name="kabid_2" id="kabid_2" class="easyui-textbox" style="width:200px"></td>
                                        </tr>
                                        <tr>
                                            <td>Kecamatan</td><td>:</td><td><input name="camatid_2" id="camatid_2" class="easyui-textbox" style="width:200px"></td>
                                        </tr>
                                        <tr>
                                            <td>Kelurahan/Desa</td><td>:</td><td><input name="desaid_2" id="desaid_2" class="easyui-textbox" style="width:200px"></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
