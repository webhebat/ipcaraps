<html>
    <head>
        ...
        <script type="text/javascript" src="<?php base_url();?>assets/js/kabupaten.js"></script>
    </head>
    <body>  
        <div id="tbOutlet" style="padding:5px;border:1px solid #ddd; border-radius: 3px">
            <table width="100%" border="0" cellspacing="2" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <a style="float:right;" href="kabupaten" class="easyui-linkbutton" target="_blank" data-options="plain:true,iconCls:'icon-new-window'"></a>
                        <a style="float:right"; href="kabupaten" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'"></a>
                    </td>                    
                </tr>
            </table>
        </div>
        <br>
        <table id="dgkabupaten"></table>
        ...
        <div id="dlg" class="easyui-dialog" style="width:400px;"
            ...
            <form id="fm" method="post" novalidate style="margin:0; padding:20px">
                <table>
                <tr>
                    <td>Nama kabupaten</td><td>:</td><td><input name="nama_unit" id="nama_unit" class="easyui-textbox" style="width:200px" required="true" ></td>
                </tr>
                <tr>
