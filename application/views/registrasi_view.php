...
<head>
    ...
    <script type="text/javascript" src="<?php base_url(); ?>assets/js/registrasi.js"></script>
    <script type="text/javascript">
        function loadsessi() {
            ...
            document.getElementById("grupnamenya").value = "<?php echo $this->session->userdata('grupid'); ?>";
            var un = document.getElementById("grupnamenya").value;
        }
    </script>
</head>
...
<body onload="loadsessi()">
    <div id="tbOutlet" style="padding:5px;border:1px solid #ddd">
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
            <tr>
                <td>
                    <a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-add" onclick="add()">Tambah Registrasi</a>
                    ...
                    <a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-followup" onclick="updateluaran()">Luaran/Followup</a>
                    <a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-excel" onclick="exportdata()">Export</a>
                </td>
                <td>
                    <a style="float:right;" href="registrasi" class="easyui-linkbutton" target="_blank" data-options="plain:true,iconCls:'icon-new-window'"></a>
                    <a style="float:right" ; href="registrasi" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'"></a>
    ...
    <input type="hidden" id="grupnamenya">
    <table id="dgregistrasi"></table>
        ...
        <form id="fm" method="post" enctype="multipart/form-data" novalidate style="margin:0; padding:10px">
            <div class="easyui-tabs" data-options="tabWidth:250" style="width:auto;height:auto;">
                <div title="Identitas" style="padding:10px">
                            ...
                            <td valign="top" style="padding-right: 30px">
                                <table>
                                    <tr>
                                        <td>Nama Lengkap</td>
                                        <td>:</td>
                                        <td><input name="nama" id="nama" class="easyui-textbox" style="width:200px" required></td>
                                    </tr>
                                    <tr>
                                        <td>NIK</td>
                                        <td>:</td>
                                        <td><input name="nik" id="nik" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Tempat Lahir</td>
                                        <td>:</td>
                                        <td><input name="tempat_lahir" id="tempat_lahir" class="easyui-textbox" style="width:200px" required></td>
                                    </tr>
                                    <tr>
                                        <td>Tgl Lahir</td>
                                        <td>:</td>
                                        <td><input name="tgl_lahir" id="tgl_lahir" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:120px" required></td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Kelamin</td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td>Alamat Tetap</td>
                                        <td>:</td>
                                        <td><input name="alamat" id="alamat" class="easyui-textbox" style="width:100%;height:40px" data-options="multiline:true"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td>RT <input name="rt" id="rt" class="easyui-textbox" style="width:50px"> RW <input name="rw" id="rw" class="easyui-textbox" style="width:50px"></td>
                                    </tr>
                                    <tr>
                                        <td>Propinsi</td>
                                        <td>:</td>
                                        <td><input name="id_prov" id="id_prov" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Kota/Kabupaten</td>
                                        <td>:</td>
                                        <td><input name="id_kab" id="id_kab" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Kecamatan</td>
                                        <td>:</td>
                                        <td><input name="id_kec" id="id_kec" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Kelurahan/Desa</td>
                                        <td>:</td>
                                        <td><input name="id_kel" id="id_kel" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                </table>
                            </td>
                            <td valign="top">
                                <table>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><input name="no_rekam" id="no_rekam" class="easyui-textbox" style="width:200px" required></td>
                                    </tr>
                                    <tr>
                                        <td>No. BPJS</td>
                                        <td>:</td>
                                        <td><input name="no_bpjs" id="no_bpjs" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>No. HP</td>
                                        <td>:</td>
                                        <td><input name="no_hp" id="no_hp" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>No. HP 2</td>
                                        <td>:</td>
                                        <td><input name="no_hp2" id="no_hp2" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Status Gizi</td>
                                        <td>:</td>
                                        <td>BB <input name="bb" id="bb" class="easyui-textbox" style="width:50px"> Kg , TB <input name="tb" id="tb" class="easyui-textbox" style="width:50px"> Cm </td>
                                    </tr>
                                    <tr>
                                        <td>Kesimpulan</td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td>LLA <input name="lla" id="lla" class="easyui-textbox" style="width:50px"> mm, TLK <input name="tlk" id="tlk" class="easyui-textbox" style="width:50px"> mm </td>
                                    </tr>
                                    <tr>
                                        <td>Nama Ayah</td>
                                        <td>:</td>
                                        <td><input name="nama_ayah" id="nama_ayah" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Ibu</td>
                                        <td>:</td>
                                        <td><input name="nama_ibu" id="nama_ibu" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Alamat Sementara</td>
                                        <td>:</td>
                                        <td><input name="alamat_2" id="alamat_2" class="easyui-textbox" style="width:100%;height:40px" data-options="multiline:true"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td>RT <input name="rt_2" id="rt_2" class="easyui-textbox" style="width:50px"> RW <input name="rw_2" id="rw_2" class="easyui-textbox" style="width:50px"></td>
                                    </tr>
                                    <tr>
                                        <td>Propinsi</td>
                                        <td>:</td>
                                        <td><input name="id_prov_2" id="id_prov_2" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Kota/Kabupaten</td>
                                        <td>:</td>
                                        <td><input name="id_kab_2" id="id_kab_2" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Kecamatan</td>
                                        <td>:</td>
                                        <td><input name="id_kec_2" id="id_kec_2" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                    <tr>
                                        <td>Kelurahan/Desa</td>
                                        <td>:</td>
                                        <td><input name="id_kel_2" id="id_kel_2" class="easyui-textbox" style="width:200px"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table>
                        <!-- <tr>
                                <td>Kecamatan</td><td>:</td><td><input name="id_kec" id="id_kec" style="width: 200px" required="true"></td>
                            </tr> -->
                    </table>
                </div>
                <div title="Perujukan & Data Lain" style="padding:10px">
                    <table>
                        <tr>
                            <td valign="top" style="padding-right: 30px">
                                <table>
                                    ...
                                    <tr>
                                        <td>Riwayat keganasan keluarga</td>
                                        <td>:</td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr id="tgriwayat">
                                        ...
                                        <td></td>
                                        <td>
                                            <table id="dgriwayat"></table>
                                        </td>
                                    </tr>
                                    <tr id="btn-hapus-riwayat">
                                        <td></td>
                                        <td></td>
                                        <td><a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-delete'" onClick="kosongkanriwayat()">Hapus</a></td>
                                    </tr>
                                </table>
                            </td>
                            <td valign="top" style="padding-right: 30px">
                                <table>
                                    ...
                                    <tr id="trppk1" style="display: none">
                                        <td>PPK 1</td>
                                        <td>:</td>
                                        <td><input name="ppk1" id="ppk1" class="easyui-textbox" style="width:200px"><input name="tgl_ppk1" id="tgl_ppk1" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:120px"></td>
                                    </tr>
                                    <tr id="trppk2" style="display: none">
                                        <td>PPK 2</td>
                                        <td>:</td>
                                        <td><input name="ppk2" id="ppk2" class="easyui-textbox" style="width:200px"><input name="tgl_ppk2" id="tgl_ppk2" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:120px"></td>
                                    </tr>
                                    <tr id="trppk3" style="display: none">
                                        <td>PPK 3</td>
                                        <td>:</td>
                                        <td><input name="ppk3" id="ppk3" class="easyui-textbox" style="width:200px"><input name="tgl_ppk3" id="tgl_ppk3" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:120px"></td>
                                    </tr>
                                    <tr>
                                        <td>Tgl Pertama Kali Konsultasi<br>kepetugas Kesehatan</td>
                                        <td>:</td>
                                        <td><input name="tgl_konsultasi" id="tgl_konsultasi" data-options="formatter:myformatter,parser:myparser" class="easyui-datebox" style="width:120px" required="true"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                ...
                <div title="Data Tumor" style="padding:10px">
                    <table>
                        <tr>
                            <td>Subgrup</td>
                            <td>:</td>
                            <td><strong><span id="labelkodesubgrup"></span></strong> - <strong><span id="labelsubgrup"></span></strong><input type="hidden" name="subgrupid" id="subgrupid"></td>
                        </tr>
                        <tr>
                            <td>Morfologi</td>
                            <td>:</td>
                            <td><strong><span id="labelkodemorfologi"></span></strong> - <strong><span id="labelmorfologi"></span></strong><input type="hidden" name="morfologiid" id="morfologiid"></td>
                        </tr>
                        <tr>
                            <td>Topografi</td>
                            <td>:</td>
                            <td><strong><span id="labelkodetopografi"></span></strong> - <strong><span id="labeltopografi"></span></strong><input type="hidden" name="topografiid" id="topografiid"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><input id="diagnosisid" name="diagnosisid" width="250"> <input class="easyui-datebox" id="tgl_diagnosis" name="tgl_diagnosis" data-options="formatter:myformatter,parser:myparser" class="easyui-datebox" style="width:120px">&nbsp;<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-down'" onclick="adddiagnosis()">simpan</a></td>
                        </tr>
                        <tr id="tgdiagnosis">
                            <td></td>
                            <td></td>
                            <td>
                                <table id="dgdiagnosis"></table>
                            </td>
                        </tr>
                        <tr id="btn-hapus-diagnosis">
                            <td></td>
                            <td></td>
                            <td><a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-delete'" onClick="kosongkandiagnosis()">Hapus</a></td>
                        </tr>
                        <tr>
                            <td>Tatalaksana</td>
                            <td>:</td>
                            <td><input style="width:260px;height:50px;" id="tatalaksanaid" name="tatalaksanaid"></td>
                        </tr>
                        <tr>
                            <td>Staging</td>
                            <td>:</td>
                            <td>
                                <inpit id="stagingid" name="stagingid">
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <td valign="top">
                        <table>
                            <tr>
                                ...
                                <td>:</td>
                                <td><strong><span id="labelnoreg"></span></strong><input type="hidden" name="registrasiid" id="registrasiid"></td>
                            </tr>
                            <tr>
                                <td>Nama Lengkap</td>
                                <td>:</td>
                                <td><strong><span id="labelnama"></span></strong></td>
                            </tr>
                            <tr>
                                <td>Tgl Abstraksi</td>
                                <td>:</td>
    ...
    <div id="dlg-search" class="easyui-dialog" style="width:500px;height: 350px; top: 100px" modal="false" closed="true" closable="false" buttons="#dlg-buttons-search" title="Filter Pencarian">
        <form id="fm-search" method="post" enctype="multipart/form-data" novalidate style="margin:0; padding:20px">
            <table>
                <tr>
                    <td>Tgl Registrasi</td>
                    <td>:</td>
                    <td><input name="key_tglregistrasi" id="key_tglregistrasi" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:110px"> s/d <input name="key_tglregistrasi2" id="key_tglregistrasi2" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:110px"></td>
                </tr>
                <tr>
                    <td>Tgl Diagnosis</td>
                    <td>:</td>
                    <td><input name="key_tgldiagnosis" id="key_tgldiagnosis" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:110px"> s/d <input name="key_tgldiagnosis2" id="key_tgldiagnosis2" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:110px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input type="radio" name="key_status" id="status_h" value="1"><label for="status_h">Hidup</label>
                        <input type="radio" name="key_status" id="status_l" value="2"><label for="status_l">Loss</label>
                        <input type="radio" name="key_status" id="status_m" value="3"><label for="status_m">Meninggal</label>
                        <input type="radio" name="key_status" id="status_u" value=""><label for="status_u">Semua</label>
                    </td>
                </tr>
                <tr>
                    <td>Unit</td>
    ...
    <!-- <div id="ft">
            <a href="#" class="easyui-linkbutton" iconCls="icon-delete" plain="true" onClick="kosongkanriwayat()">pupus</a>
        </div> 
        <div id="ft2">
            <a href="#" class="easyui-linkbutton" iconCls="icon-delete" plain="true" onClick="kosongkandiagnosis()">pupus</a>
        </div>-->
</body>
