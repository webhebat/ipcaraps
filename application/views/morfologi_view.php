<html>
    <head>
        ...
        <script type="text/javascript" src="<?php base_url();?>assets/js/morfologi.js"></script>
    </head>
    <body>  
        <div id="tbOutlet" style="padding:5px;border:1px solid #ddd">
            <table width="100%" border="0" cellspacing="2" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <a style="float:right;" href="morfologi" class="easyui-linkbutton" target="_blank" data-options="plain:true,iconCls:'icon-new-window'"></a>
                        <a style="float:right"; href="morfologi" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'"></a>
                    </td>                    
                </tr>
            </table>
        </div>
        ...
        <div id="dlg" class="easyui-dialog" style="auto;top: 50px"
            ...
            <form id="fm" method="post" novalidate style="margin:0; padding:20px">
                <table>
                    ...
                    <tr>
                        <td>Kode</td><td>:</td><td><input name="kodemorfologi" id="kodemorfologi" class="easyui-textbox" style="width:100px" required="true"><input type="hidden" name="h_kode" id="h_kode"></td>
                    </tr>
                    <tr>
                        <td>Morfologi</td><td>:</td><td><input name="morfologi" id="morfologi" class="easyui-textbox" style="width:100%;height:50px" data-options="multiline:true" required="true"></td>
                    </tr>
                </table>
            </form>
        </div>
