<html>
    ...
    <body onload="loadsessi()">  
                    ...
                    <td valign="top">
                        <table>
                            ...
                            <tr id="trkomplikasikemo" style="display: none">
                                <td>Komplikasi Kemoterapi</td><td>:</td><td><input name="komplikasi_kemoterapi" id="komplikasi_kemoterapi" class="easyui-textbox" style="width:200px;" ></td>
                            </tr>
        ...
        <div id="dlg-search" class="easyui-dialog" style="width:500px;height: 250px; top: 100px"
             modal="false" closed="true" closable="false" buttons="#dlg-buttons-search" title="Filter Pencarian">
                <form id="fm-search" method="post"  enctype="multipart/form-data" novalidate style="margin:0; padding:20px">
                    <table>
                        <tr><td>Tgl Kunjungan</td><td>:</td><td><input name="key_tgldatang" id="key_tgldatang" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:110px" > s/d <input name="key_tgldatang2" id="key_tgldatang2" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:110px" ></td>
                        </tr>
                        <tr>
                            <td>Status Validasi</td><td>:</td><td><input type="radio" name="key_validasi" id="sudah" value="y"><label for="sudah">Sudah divalidasi</label>
