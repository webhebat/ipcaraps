<html>
    <head>
        ...
        <script type="text/javascript" src="<?php base_url();?>assets/js/kecamatan.js"></script>
    </head>
    <body>  
        <div id="tbOutlet" style="padding:5px;border:1px solid #ddd">
            <table width="100%" border="0" cellspacing="2" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <a style="float:right;" href="kecamatan" class="easyui-linkbutton" target="_blank" data-options="plain:true,iconCls:'icon-new-window'"></a>
                        <a style="float:right"; href="kecamatan" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'"></a>
                    </td>                    
                </tr>
            </table>
        </div>
        <br>
        <table id="dgkecamatan"></table>
        ...
        <div id="dlg" class="easyui-dialog" style="width:400px;"
            ...
            <form id="fm" method="post" novalidate style="margin:0; padding:20px">
                <table>
                <tr>
                    <td>Kecamatan</td><td>:</td><td><input name="kecamatan" id="kecamatan" class="easyui-textbox" style="width:200px" required="true" ></td>
                </tr>
                <tr>
                    <!-- <td>Kabupaten</td><td>:</td><td><input name="kabid" id="kabid" style="width: 200px" required="true"></td>
                    </tr> -->
                <tr>
                    <td>Kode Pos</td><td>:</td><td><input name="kodepos" id="kodepos" class="easyui-textbox" style="width:200px"></td>
                </tr>
                <tr>
