...
<html lang="en">
    ...
    <head>
        ...
        <title>IPCAR-Indonesian Pediatric Cancer Registry</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>IP-CAR</strong> Indonesian Pediatric Cancer Registry
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		...
                        		<div class="form-top-right">
                        			<!--<i class="fa fa-key"></i>-->
                                     <img src="<?php echo base_url()?>assets/login/img/logo.png" class="img-rounded"> 
                        		</div>
                            </div>
                            <div class="form-bottom">
			                    <form id="formlogin" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="form-username" placeholder="Username..." class="form-username form-control required" id="form-username" autocomplete="false">
			                        </div>
			                        <div class="form-group pass_show">
			                        	<label class="sr-only" for="form-password">Password</label>
			                        	<input type="password" name="form-password" placeholder="Password..." class="form-password form-control required" id="form-password" >
			                        </div>
