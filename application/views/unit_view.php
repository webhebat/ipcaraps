<html>
    <head>
        ...
        <script type="text/javascript" src="<?php base_url();?>assets/js/unit.js"></script>
    </head>
    <body>  
        <div id="tbOutlet" style="padding:5px;border:1px solid #ddd">
            <table width="100%" border="0" cellspacing="2" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <a style="float:right;" href="unit" class="easyui-linkbutton" target="_blank" data-options="plain:true,iconCls:'icon-new-window'"></a>
                        <a style="float:right"; href="unit" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'"></a>
                    </td>                    
                </tr>
            </table>
        </div>
        ...
        <div id="dlg" class="easyui-dialog" style="width:400px;top: 100px;"
            closed="true" buttons="#dlg-buttons" modal="true">
            <form id="fm" method="post" novalidate style="margin:0; padding:20px">
                <table>
                    <tr>
                        <td>No Unit</td><td>:</td><td><strong><span id="labelnounit"></span></strong><input type="hidden" name="no_unit" id="no_unit"></td>
                    </tr>
                    <tr>
                    ...
                    <!-- <tr>
                        <td>Kode RS</td><td>:</td><td><input name="kode" id="kode" class="easyui-textbox" style="width:200px" required="true" ></td>
                    </tr> -->
                </table>
            </form>
        </div>
