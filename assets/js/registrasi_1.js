$(function(){
	...
	$('#dgregistrasi').datagrid({ 
        ...
        columns:[[   
            ...
            {field:'kecamatan',title:'Kecamatan',width:150,align:'left'},
            {field:'desa',title:'Desa',width:150,align:'left'},
    ...
    $('#dgsubgrup').datagrid({ 
        ...
        columns:[[  
            {field:'subgrup',title:'Pilih Sub Grup',halign:'center',align:'left'}
        ]]
    });
    ...
    $('#propid').combogrid({
        ...
        onSelect: function(index,row){
                    ...
                    var url = 'registrasi/kabupaten/'+row.propid;
    ...
    $('#kabid').combogrid({
        ...
        onSelect: function(index,row){
                    var url = 'registrasi/kecamatan/'+row.kabid;
    ...
    $('#camatid').combogrid({
        ...
        onSelect: function(index,row){
            var url = 'registrasi/desa/'+row.camatid;
...
function no_registrasi(){
   ...
   var no = '';
   $.getJSON('registrasi/no_registrasi', { get_param: 'value' }, function(data) {
...
function exportdata(){
    ...
    window.open('registrasi/export?search='+value+'&tgl1='+tgl1+'&tgl2='+tgl2+'&validasi='+validasi+'&luaran='+luaran+'&unitid='+unitid+'&subgrupid='+subgrupid);
}
