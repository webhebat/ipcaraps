$(function(){
	...
	$('#dgkabupaten').datagrid({ 
        ...
        columns:[[   
            {field:'kabid',title:'ID KAB',width:400,align:'left'},
            {field:'kabupaten',title:'Nama kabupaten',width:400,align:'left'},
            {field:'ibukota',title:'Ibukota',width:350,align:'left'},
            {field:'propinsi',title:'Propinsi',width:350,align:'left'},
            {field:'lat',title:'Lat',width:350,align:'left'},
            {field:'lng',title:'Lng',width:400,align:'left'}
        ]], 
        showFooter:true
